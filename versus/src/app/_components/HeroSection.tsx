    ...
    <section className="mb-16">
      <div className="text-right">
        <p className="flex items-center justify-end gap-4">
          <a
            href="https://github.com/williamavholmberg"
            target="_blank"
          ...
          •
          <a
            href="https://www.youtube.com/watch?v=JMluUDJXN5Q"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-primary transition-colors inline-flex items-center gap-1"
          >
          ...
          •
          <a
            href="https://www.linkedin.com/in/william-holmberg-361357164/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-primary transition-colors inline-flex items-center gap-1"
          >
        ...
        <p className="text-sm text-muted-foreground italic mb-2">
          System down? That&apos;s probably because y&apos;all are too curious! 🧐 
          My credits vanished like cookies in a dev meeting 🍪💨
        </p>
        <p className="text-sm text-muted-foreground italic mb-2">
